...
import br.com.projetopoo.controller.CategoriaController;
import br.com.projetopoo.controller.ProdutoController;
import br.com.projetopoo.modelo.Categoria;
import br.com.projetopoo.modelo.Produto;
...
public class ProdutoCategoriaFrame extends JFrame {
	...
	private void salvar()  {
		if (!textoNome.getText().equals("") && !textoDescricao.getText().equals("")) {
			...
			JOptionPane.showMessageDialog(this, "Nome e Descricaoo devem ser informados.");
		}
	}
